...
public enum WebViewWebErrorStatus
{
    //
    // 摘要:
    ...
    //     following cases: 1) when the app cancels a navigation via NavigationStarting
    //     event. 2) For original navigation if the app navigates the WebView2 in a rapid
    ...
    //     using BasicAuthenticationRequested. HTTP response status code in this case is
    //     401. See status code reference here: https://developer.mozilla.org/docs/Web/HTTP/Status.
